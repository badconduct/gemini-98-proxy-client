  ...
  const responseSchema = {
    ...
    properties: {
      ...
      responseDelaySeconds: {
        type: "INTEGER",
        description:
          "The number of seconds of 'silent thinking' or 'away' time before you start typing a reply. This value represents the pause before the user sees a 'typing' indicator. Use a wide range: 5-20 for high interest, 20-60 for medium, up to 180 for low interest/relationship.",
      },
      isImageRequest: {
        type: "BOOLEAN",
        description:
...
It is currently the late 1990s. All your references must be from 1999 or earlier.${timeContextSection}
