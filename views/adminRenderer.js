...
function renderUsersPage({ users, adminUserName, guestCount }) {
  ...
  const styles = `
      ...
      #users-container { padding: 10px; background-color: #FFFFFF; border: 1px solid #000000; min-height: 200px; max-height: 300px; overflow-y: auto; border-top: none; }
      .guest-info { padding: 10px 10px 10px; background-color: #FFFFFF; border: 1px solid #000000; border-bottom: none; }
      .guest-info p { font-size: 11px; margin: 5px 0 0 0; color: #505050; }
  ...
  const guestInfoHtml = `
    <div class="guest-info">
      <b>Total Guest Logins:</b> ${guestCount || 0}
      <p>Guest profiles are temporary and automatically deleted after a period of inactivity.</p>
    </div>
  `;
